...
<div class="row">
   ...
   <div class="panel panel-primary">
      <div class ="panel-heading">Billing Address</div>
         <div class="panel-body">
            <form:form class="form-horizontal" action="${flowExecutionUrl}&_eventId=submitBillingAddress" commandName="billingAddress">
               <div class="form-group">
                 <label for ="" class="control-label"> Line 1 </label>
                    <div class ="col-sm 10">
 ...
 <img src="<c:url value="/lib/image/billing2.png"/>" style="width:600px;height:600px">
 </div> 
   </div>
   </div>
</body>
